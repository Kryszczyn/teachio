    ...
    <div class="container-fluid py-4 shadow-blur">
      ...
      <div class=" p-2 border-radius-xl  mx-0" >
        <div class="row mx-0" >
          ...
          <div class="col-12 py-4 border rounded d-flex  align-items-center justify-content-center plan_background">
            <div class="py-2 d-flex  align-items-center justify-content-center">  
              <p class="fw-bold m-0  text-white">Mojde Dane</p>
            </div>
          </div>
            ...
            <div class="row mx-0 ">
              ...
              <p class="fw-bold m-0  text-white">Imie i nazwisko</p>
              </div> 
              <div class="col-10 py-2 border rounded d-flex align-items-center  plan_col">
              <p class="fw-bold m-0  ">Krystian Maj</p>
              </div>
            ...
            <div class="row mx-0 ">
              <div class="col-2 py-2 border rounded d-flex flex-column align-items-center justify-content-center plan_background">
              <p class="fw-bold m-0  text-white">Klasa</p>
              </div> 
              <div class="col-10 py-2 border rounded d-flex align-items-center  plan_col">
              <p class="fw-bold m-0  ">3a</p>
              </div>
            ...
            <div class="row mx-0 ">
              <div class="col-2 py-2 border rounded d-flex flex-column align-items-center justify-content-center plan_background">
              <p class="fw-bold m-0  text-white">Nr w dzienniku</p>
              </div> 
              <div class="col-10 py-2 border rounded d-flex align-items-center  plan_col">
              <p class="fw-bold m-0  ">23</p>
              </div>
            ...
            <div class="row mx-0 ">
              <div class="col-2 py-2 border rounded d-flex flex-column align-items-center justify-content-center plan_background">
              <p class="fw-bold m-0  text-white">Telefon</p>
              </div> 
              <div class="col-10 py-2 border rounded d-flex align-items-center  plan_col">
              <p class="fw-bold m-0  ">692 137 420</p>
              </div>
            ...
            <div class="row mx-0 ">
              <div class="col-2 py-2 border rounded d-flex flex-column align-items-center justify-content-center plan_background">
              <p class="fw-bold m-0  text-white">Wychowawca</p>
              </div> 
              <div class="col-10 py-2 border rounded d-flex align-items-center  plan_col">
              <p class="fw-bold m-0  ">Marek Szparek</p>
              </div>
          ...
          <div class="col-12 py-4 border rounded d-flex  align-items-center justify-content-center plan_background">
            <div class="py-2 d-flex  align-items-center justify-content-center">  
              <p class="fw-bold m-0  text-white">Dane Logowania</p>
            </div>
          </div>

          <div class="row mx-0 ">
              <div class="col-2 py-2 border rounded d-flex flex-column align-items-center justify-content-center plan_background">
              <p class="fw-bold m-0  text-white">E-mail</p>
              </div> 
              <div class="col-10 py-2 border rounded d-flex align-items-center  plan_col">
              <p class="fw-bold m-0  ">krystian.maj@teachio.pl</p>
              </div>
            ...
            <div class="row mx-0 ">
              <div class="col-2 py-2 border rounded d-flex align-items-center justify-content-center plan_background">
                <p class="fw-bold m-0 me-2 text-white">Hasło</p>
                <button type="button" class="modal-open btn bg-gradient-success btn-block m-0">Zmień hasło</button>
              </div> 

              
                <div class="col-10 py-2 border rounded d-flex align-items-center justify-content-space-between plan_col">
                ...
                if($_SESSION['type'] == 'admin' || $_SESSION['type'] == 'teacher')
                 {
                      echo '<div class="col-4" >
                       <button type="button" class="modal-open btn bg-gradient-success btn-block mb-3" data-bs-toggle="modal" data-type="DODAJ_UWAGE" data-refresh="0" data-values=""  data-bs-target="#modal">Zmień dane</button>
                     </div>';
                  }
                 ?>
