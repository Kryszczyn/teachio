...
export const Calendar = (id) => ({ 
    ...
    render(y, m) {
        ...
        if (isNaN(y) && isNaN(this.y)) {
            ...
            this.y = y>1600 ? y : moment().year();
        }
        if (isNaN(m) && isNaN(this.m)) {
            this.m = moment().month();
        } else if ((!isNaN(m) && isNaN(this.m)) || (!isNaN(m) && !isNaN(this.m))) {
            this.m = m>=0 ? m : moment().month();
        }

        const d = moment().year(this.y).month(this.m).date(1);
        const now = moment();
        ...
        <div class="calendar noselect p-5">
            <div class="month-year-btn d-flex justify-content-center align-items-center mb-2">
                ...
                <div class="month-year d-flex justify-content-center align-items-center">
                    <div class="month mb-2 mr-2">${moment().month(this.m).format('MM')}- </div>
                    <div class="year mb-2"> ${this.y}</div>
                </div>
                <a class="next-month"><i class="fas fa-caret-right fa-lg m-3" aria-hidden="true"></i></a>
            </div>
            <ol class="day-names list-unstyled">
                <li><h6 class="initials">Nie</h6></li>
                <li><h6 class="initials">Pon</h6></li>
                <li><h6 class="initials">Wto</h6></li>
                <li><h6 class="initials">Śr</h6></li>
                <li><h6 class="initials">Czw</h6></li>
                <li><h6 class="initials">Pią</h6></li>
                <li><h6 class="initials">Sob</h6></li>
            </ol>
        </div>
        `);
        ...
        this.el.innerHTML = ''; //zamiana kalendarza
