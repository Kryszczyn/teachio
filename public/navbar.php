          ...
          <ul class="navbar-nav justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><?php echo $userData[0]['fname'] .' '. $userData[0]['lname']; ?></span>
              </a>
            </li>
            <li class="nav-item d-flex align-items-center">
              <button class="logout btn btn-outline-primary btn-sm mb-0 ms-3">Wyloguj</button>
            </li>
